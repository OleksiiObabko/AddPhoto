 ...
 /*! smooth-scroll v16.1.3 | (c) 2020 Chris Ferdinandi | MIT License | http://github.com/cferdinandi/smooth-scroll */            window.Element && !Element.prototype.closest && (Element.prototype.closest = function(e) {
    ...
    (() => {
                ...
                document.addEventListener("click", function(e) {
                    ...
                    if (buttonOpen) {
                        ...
                        if ("error" !== this._dataValue) {
                            ...
                            this.open();
                            return;
                        } else this.popupLogging(`Ой ой ой, не заполнен атрибут у ${buttonOpen.classList}`);
                        return;
                    }
        ...
        let gotoBlock = (targetBlock, noHeader = false, speed = 500, offsetTop = 0) => {
            ...
            } else FLS(`[gotoBlock]: Ой ой ой..Такого блока нет на странице: ${targetBlock}`);
        };
        ...
        function initSliders() {
            ...
            if (document.querySelector(".locations__slider")) new core(".locations__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
...
***************************************************************************** */
        ...
        let numberAll = document.querySelectorAll(".card-additional__number");
        let priceAll = document.querySelectorAll(".card-additional__price");
        let numberButton = document.getElementById("choice-confirm");
        function script_Math() {
            let numberInput = document.getElementById("choice-number").value;
            if (numberInput > 0 && numberInput % 1 == 0 && !isNaN(numberInput)) {
                for (let i = 0; i < numberAll.length; i++) {
                    let number = numberAll[i];
                    number.innerHTML = numberInput;
                }
                for (let i = 0; i < priceAll.length; i++) {
                    let price = priceAll[i];
                    price.innerHTML = price.innerHTML * numberInput;
                }
            }
        }
        numberButton.addEventListener("click", script_Math);
        ...
        function uploadFile(file) {
            ...
            reader.onload = function(e) {
                formPreview.innerHTML = `<img class="file__img" src="${e.target.result}" alt="Фото">`;
            };
